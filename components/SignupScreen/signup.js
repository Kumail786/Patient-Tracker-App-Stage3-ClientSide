                        ...
                        <KeyboardAwareScrollView style={{ flex: 1 }}>
                            ...
                            <View style={styles.inputView}>
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity delayLongPress={0} style={styles.buttons} onPress={async () => {
                                        ...
                                        <Animatable.Text animation="pulse" easing="ease-in" iterationCount="infinite" style={styles.buttontext}>SignUp</Animatable.Text>
                                    </TouchableOpacity>

                                    <TouchableOpacity delayLongPress={0} style={styles.buttons} onPress={() => { Actions.login() }}>
                                        <Animatable.Text animation="pulse" easing="ease-in" iterationCount="infinite" style={styles.buttontext}>Already Registered? Sign In</Animatable.Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
